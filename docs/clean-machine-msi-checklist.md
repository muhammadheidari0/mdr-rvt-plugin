...
## Build Under Test (v0.4.1)

- ZIP: `mdr-rvt-plugin-0.4.1-rvt2026.zip`
- MSI: `mdr-rvt-plugin-0.4.1-rvt2026.msi`
...
```powershell
msiexec /i "mdr-rvt-plugin-0.4.1-rvt2026.msi" /qn /norestart
```
...
```powershell
msiexec /x "mdr-rvt-plugin-0.4.1-rvt2026.msi" /qn /norestart
```
