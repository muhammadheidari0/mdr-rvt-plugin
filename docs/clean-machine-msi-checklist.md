...
## Build Under Test (v0.4.0)

- ZIP: `mdr-rvt-plugin-0.4.0-rvt2026.zip`
- MSI: `mdr-rvt-plugin-0.4.0-rvt2026.msi`
...
```powershell
msiexec /i "mdr-rvt-plugin-0.4.0-rvt2026.msi" /qn /norestart
```
...
```powershell
msiexec /x "mdr-rvt-plugin-0.4.0-rvt2026.msi" /qn /norestart
```
