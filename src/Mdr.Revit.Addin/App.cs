    ...
    public sealed class App
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            PublishSheetsCommandRequest commandRequest = new PublishSheetsCommandRequest
            {
                ...
                PluginVersion = string.IsNullOrWhiteSpace(config.PluginVersion) ? "0.4.1" : config.PluginVersion,
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                CurrentVersion = string.IsNullOrWhiteSpace(config.PluginVersion) ? "0.4.1" : config.PluginVersion,
