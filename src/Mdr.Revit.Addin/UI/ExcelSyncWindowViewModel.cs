...
namespace Mdr.Revit.Addin.UI
{
    public sealed class ExcelSyncWindowViewModel
    {
            ...
            string anchorColumn)
        {
            ...
            if (!string.IsNullOrWhiteSpace(defaultWorkbookPath))
            {
                FilePath = Environment.ExpandEnvironmentVariables(defaultWorkbookPath.Replace("/", "\\")).Trim();
                _filePathAutoGenerated = false;
            }
